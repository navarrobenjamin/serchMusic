...
<?php } ?>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <h1 class="text-center">Productos ordenados desde los mas baratos</h1> 
       ...
       $mar=$_SESSION['marca'];
       $consultamax="SELECT * FROM instrumento a,tienda  b  where a.marca_instru='$mar' and a.id_tienda=b.id_tienda ORDER BY a.precio_unitario desc ";
    
        
        $ejecuta=$link->query($consultamax);
                          // $fila4=$ejecuta4->fetch_array();
         ...
         <?php   do{ ?>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img src="<?php echo $fila['foto_instru'];  ?>"height="143" width="170"  > </a>
              <div class="card-body">
                <h6 class="card-title">
              ...
              <div class="card-footer">
                <small class="text-muted"> <?php echo "Nombre de la tienda: ".$fila['nom_tienda']; ?></small>
              </div>
            </div>
          </div>
